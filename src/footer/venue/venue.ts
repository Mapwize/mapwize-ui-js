...
export class FooterVenue extends DefaultControl {
  ...
  private _onLanguageItemClick (e: JQueryEventObject) {
    ...
    this._initializeControl() // TODO: use mapwize:languagechange event when it will be available in sdk
  }
  ...
  private _onUniverseWillChange (e: any) {
    // this._initializeControl(true) // TODO: add loading animation in html
  }
  private _onUniverseChange (e: any) {
    this._initializeControl()
  }
}
