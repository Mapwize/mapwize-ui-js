...
* @param {function} [options.onPlaceSelectedChange]  (optional, function) Callback called when a place or placeList is selected or unselected. Take the selected object as parameter
