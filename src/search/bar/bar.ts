...
export class SearchBar extends DefaultControl {
    ...
    public color(){
        if (this._options.color) {
            ...
            this._container.find('#mwz-directionsButton img').attr('src', replaceColorInBase64svg(directionIconB64, this._options.color))
            this._container.find('#mwz-menuButton img').attr('src', replaceColorInBase64svg(menuIconB64, this._options.color))
        }
    }
    public destroy() {
